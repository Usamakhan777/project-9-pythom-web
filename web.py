...
# ============================================
st.set_page_config(
    page_title="Muhammad Usama Khan | Portfolio",
    page_icon="🌟",
    layout="wide",
...
with col2:
    ...
    # Social badges
    st.write("""
    [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?logo=linkedin)](https://www.linkedin.com/in/usama-khan-94635b279/)
    [![GitHub](https://img.shields.io/badge/GitHub-181717?logo=github)](https://github.com/Usamakhan777)
...
with about_col2:
    ...
    st.write("""
    🛠️ **Shop**  
    Electronics Itam Repairing 
    """)
    """
    💼 **Mobile Company**  
    Tecno Transision Electronics 
    """
...
with st.expander("🔍 Project 1: BMI Calculator", expanded=True):
    ...
    with proj_col2:
        ...
        - Automated reporting
        """)
        st.link_button("View on GitHub", "https://github.com/Usamakhan777/project-5-Hangman-game")
...
with st.expander("📊 Project 2: Cooldown Timer"):
    ...
    with proj_col2:
        ...
        """)
        st.link_button("View code on Github", "https://github.com/Usamakhan777/project-4-Rock-p-s")
        st.link_button("")
...
contact_form = """
<form action="https://formsubmit.co/uasamkhan574@gmail.com" method="POST">
...
# ============================================
st.markdown("---")
st.markdown("© 2025 Usama Khan | Made with Streamlit")